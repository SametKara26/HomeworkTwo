...
names(wizards) <- c("Harry", "Ron", "Fred", "George", "Sirius")
ranking <- c(4, 2, 5, 1, 3)
ranking <- c(Harry = 4, Ron = 2, Fred = 5, George = 1, Sirius = 3)
```
...
savings=data.frame(years,income,expenses)
```
